...
export function Hero() {
  ...
  return (
    <section
      ...
      style={{
        background: `radial-gradient(700px circle at ${pos.x}% ${pos.y}%, rgba(214,199,161,0.07), transparent 65%)`,
      }}
    >
      <div className="mx-auto w-full max-w-6xl px-6 pt-28 pb-16">
        ...
        <motion.dl
          ...
          className="mt-20 grid grid-cols-2 gap-x-8 gap-y-10 border-t border-line pt-10 md:grid-cols-4"
        >
          {stats.map((s) => (
            <div key={s.label}>
